...
Test(init_map, map_borders)
{
	struct s_tt
	{
	    ...
	    {"51) invalid border:", ft_split("./bin maps/valid/borders51.cub", ' '), 0},
	    {"52) invalid border:", ft_split("./bin maps/valid/borders52.cub", ' '), 0},
	    {"53) invalid border:", ft_split("./bin maps/valid/borders53.cub", ' '), 0},
	    {"54) invalid border:", ft_split("./bin maps/valid/borders54.cub", ' '), 0},
	    {"55) invalid border:", ft_split("./bin maps/valid/borders55.cub", ' '), 0},
	    {"56) invalid border:", ft_split("./bin maps/valid/borders56.cub", ' '), 0},
	    {"57) invalid border:", ft_split("./bin maps/valid/borders57.cub", ' '), 0},
	    {"58) invalid border:", ft_split("./bin maps/valid/borders58.cub", ' '), 0},
	    {"59) invalid border:", ft_split("./bin maps/valid/borders59.cub", ' '), 0},
	    {"60) valid border:", ft_split("./bin maps/valid/borders60.cub", ' '), 1},
	    {"61) valid border:", ft_split("./bin maps/valid/borders61.cub", ' '), 1},
	    {"62) valid border:", ft_split("./bin maps/valid/borders62.cub", ' '), 1},
	    {"63) valid border:", ft_split("./bin maps/valid/borders63.cub", ' '), 1},
	    {"64) valid border:", ft_split("./bin maps/valid/borders64.cub", ' '), 1},
	    {"65) valid border:", ft_split("./bin maps/valid/borders65.cub", ' '), 1},
	    {"66) invalid border:", ft_split("./bin maps/valid/borders66.cub", ' '), 0},
	    {"67) invalid border:", ft_split("./bin maps/valid/borders67.cub", ' '), 0},
	    {"68) invalid border:", ft_split("./bin maps/valid/borders68.cub", ' '), 0},
	    {"69) invalid border:", ft_split("./bin maps/valid/borders69.cub", ' '), 0},
	    {"70) valid border:", ft_split("./bin maps/valid/borders70.cub", ' '), 1},
	    {"71) invalid horizontal empty line:", ft_split("./bin maps/valid/borders71.cub", ' '), 0},
	    {"72) invalid horizontal empty line:", ft_split("./bin maps/valid/borders72.cub", ' '), 0},
	    {"73) invalid horizontal empty line:", ft_split("./bin maps/valid/borders73.cub", ' '), 0},
	    {"74) valid map:", ft_split("./bin maps/valid/borders74.cub", ' '), 1},
	    {"75) invalid horizontal empty line:", ft_split("./bin maps/valid/borders75.cub", ' '), 0},
	    {"76) invalid horizontal empty line:", ft_split("./bin maps/valid/borders76.cub", ' '), 0},
	    {"77) invalid horizontal empty line:", ft_split("./bin maps/valid/borders77.cub", ' '), 0},
	    {"79) valid map:", ft_split("./bin maps/valid/borders79.cub", ' '), 1},
	    {"80) valid map:", ft_split("./bin maps/valid/borders80.cub", ' '), 1},
	    {"81) valid map:", ft_split("./bin maps/valid/borders81.cub", ' '), 1},
	};
	size_t n = sizeof(tt) / sizeof(tt[0]);
